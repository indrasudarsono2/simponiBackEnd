...
add_table(doc,[["Document status","Draft"],["Document version","0.1"],["Prepared for","SIMPONI and e-chain technical teams"],["Source baseline",str(ROOT.relative_to(Path(__file__).parents[1]))],["Prepared date","31 August 2026"],["Classification","Internal technical review"]])
...
add_table(doc,[["Version","Date","Status","Description"],["0.1","31 Aug 2026","Draft","Initial consolidated ICD generated from the e-chain integration documentation set."]])
