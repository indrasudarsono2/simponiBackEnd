...
CREATE TABLE `ApplicationDoc` (
    ...
    UNIQUE INDEX `ApplicationDoc_eventUserId_key`(`eventUserId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Rating` ADD CONSTRAINT `Rating_professionInBranchId_fkey` FOREIGN KEY (`professionInBranchId`) REFERENCES `ProfessionInBranch`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `PracticalTest` ADD CONSTRAINT `PracticalTest_appRatingId_fkey` FOREIGN KEY (`appRatingId`) REFERENCES `AppRating`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `SubBranchUnitRating` ADD CONSTRAINT `SubBranchUnitRating_rattingId_fkey` FOREIGN KEY (`rattingId`) REFERENCES `Rating`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `AppRating` ADD CONSTRAINT `AppRating_applicationDocId_fkey` FOREIGN KEY (`applicationDocId`) REFERENCES `ApplicationDoc`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
